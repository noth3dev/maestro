...
Carnegie keeps provider credentials inside the authenticated Model Gateway. The Control Plane receives opaque bindings and never persists or logs provider secrets.
