...
export const exposedApiMethods = [
  "listGoals", "getGoal", "getSettings", "updateSettingsPreferences", "updateSettingsModelPool", "updateSettingsAuthorityDefaults", "listProviderConnections", "loginProvider", "logoutProvider", "getBudgetSummary", "getBillingSummary", "getChannel", "postChannelMessage", "getProjection", "listEvents", "streamEvents",
