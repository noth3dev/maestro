...
const actionOptions: Record<string, readonly string[]> = {
  ...
  "goal select": ["--goal-id"],
  "goal transition": ["--goal-id", "--expected-version", "--to", "--command-id"],
  "goal pause": ["--goal-id", "--expected-version", "--command-id"],
  "goal resume": ["--goal-id", "--expected-version", "--command-id"],
  "goal stop": ["--goal-id", "--expected-version", "--command-id"],
  "goal emergency-stop": ["--goal-id", "--expected-version", "--command-id"],
  ...
  "encore review": ["--goal-id", "--review-json", "--command-id"],
  "encore-council list": ["--goal-id"],
