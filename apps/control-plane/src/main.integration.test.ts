...
if (!databaseUrl) {
  ...
  beforeEach(async () => {
    await setupPool.query("TRUNCATE goal_leases, outbox, goal_events, command_receipts, goals, local_operator_credentials, local_operators, authority_decisions, authority_records, goal_controls CASCADE");
  });
