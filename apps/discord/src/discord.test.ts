...
import { DiscordAuthenticationError, DiscordFreshnessError, DiscordReplayError, deriveDiscordIncidentFingerprint, signDiscordSignal, verifyDiscordSignal, type DiscordSignal } from "@carnegie/domain";
