...
const bundle: Omit<EvidenceBundle, "assembledAt"> = {
  ...
  gitIntegration: {}, certifications: {}, metronomeFindings: [], metronomeChallenges: [], encoreRounds: [], budgetReservations: [], evidenceRecords: [], actualCosts: [], authorityRecords: [], authorityDecisions: [], councilBriefs: [],
