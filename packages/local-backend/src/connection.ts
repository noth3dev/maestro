...
export interface ConnectionEnvironment {
  ...
  MAESTRO_MODEL_ROUTING_MODE?: "ensemble" | "pin";
  MAESTRO_NATIVE_MODEL?: string;
  MAESTRO_ENSEMBLE_CANDIDATE_CATALOG?: string;
  MAESTRO_MODEL_ACCOUNT_REFS?: string;
  MAESTRO_MODEL_MAP?: string;
