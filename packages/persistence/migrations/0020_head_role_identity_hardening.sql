...
UPDATE council_participants AS participant
SET head_role_id = participation.head_role_id
FROM head_councils AS council,
     goal_head_participations AS participation
WHERE participant.council_id = council.council_id
  AND participation.goal_id = council.goal_id
