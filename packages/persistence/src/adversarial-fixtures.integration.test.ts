...
import * as gitAdapter from "@carnegie/git-adapter";
import { localGitPort } from "../../../test/git-port.js";
import { type DecisionPacket, type DepartmentPlanSubstance, type ExecutionAdmission, type ExecutionKernelPort, type IndependentBrief, type MissionBundleSubstance, type TaskContractSubstance } from "@carnegie/domain";
