...
/**
 * Durably closes a grant that has naturally lapsed (past its own expiry, or its Goal reaching a
 * terminal state) instead of only rejecting the current command in memory and leaving
