...
describe("durable routing work snapshot read", () => {
  it("composes the Mission Bundle and durable Goal overlay snapshot", async () => {
    ...
    expect(snapshot.missionBundleRef).toBe("bundle-hash");
