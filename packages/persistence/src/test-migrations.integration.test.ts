...
const expectedTables = [
  ...
  "metronome_challenges", "metronome_findings", "improvement_digests", "budget_forecasts", "budget_reservations", "integration_commits", "worker_worktrees", "goal_integration_branches",
