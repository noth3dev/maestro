...
- Encore and improvements;
- Discord and incidents;
...
- Concertmaster conversation is primary.
...
Concertmaster remains the geometric and operational center.
...
- Metronome as observing perimeter;
- Encore Council and Improvement Lab outside execution rings;
- Discord outside the primary failure boundary with incident edges inward.
...
Discord signal, triage organization, Incident Task Contract, remediation plans and branches, certification, and resolution.
...
- talk to Concertmaster or a relevant Head without bypassing reporting records;
...
- review Metronome challenges and Council dissent;
...
2. Build global shell, navigation, Concertmaster home, Task Contract, and current Goal summary.
...
5. Build Git, environment, device, Discord, incident, and improvement views.
...
9. Render multiple Goals, sleeping Departments, Metronome perimeter, Council, and Discord correctly.
