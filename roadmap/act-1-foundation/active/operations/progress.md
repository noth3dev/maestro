...
- Real live verification: final single frame `.artifacts/e4-live-help-glance` is reproducible at 80x24; final dynamic matrix `.artifacts/e4-live-help-final-matrix` contains six cases (80x24, 120x40, 200x50, color and `NO_COLOR`), each explicitly `reproducible: false`.
