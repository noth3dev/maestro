...
- 2026-09-11 Plan 6 §S1 `knowledge-store-and-promotion`: reserved migration 0087 before writing its SQL. RED domain and PostgreSQL integration tests are added and currently fail because the organizational knowledge domain and persistence modules do not yet exist.
