...
- 2026-09-14 branding correction: **Maestro remains the product name**. The overly broad product-wide Carnegie rename was reversed. Carnegie is retained only as the existing Carnegie desktop app's user-facing brand; Maestro package scopes, CLI/API/runtime names, compatibility identifiers, and repository documentation remain unchanged.
