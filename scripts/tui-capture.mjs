...
function isMissingSessionError(error) {
  ...
  return /no server running|session does not exist|can't find session|no such session|error connecting to \S*[/\\]tmux-\d+[/\\]default \(no such file or directory\)/i.test(text);
}
