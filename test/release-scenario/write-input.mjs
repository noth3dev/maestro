...
if (kind === "contract") {
  ...
  value = { projectId, contractId: parsed.values.contract, departmentId: "engineering", headRoleId: "head:engineering", requestedContribution: "Plan the smallest safe repair.", urgency: "normal", contextScope: ["discount repair", "disposable target"], budgetEffect: "none", reason: "Necessary execution planning only", evidence: { source: "release-scenario-runbook" } };
