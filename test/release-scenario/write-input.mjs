...
const parsed = parseArgs({ options: { kind: { type: "string" }, project: { type: "string" }, repository: { type: "string" }, base: { type: "string" }, out: { type: "string" }, contract: { type: "string" }, target: { type: "string" }, worktree: { type: "string" }, department: { type: "string" }, "evidence-id": { type: "string" }, item: { type: "string" }, verdict: { type: "string" } } });
