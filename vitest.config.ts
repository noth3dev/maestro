...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@maestro/persistence/testing": new URL("./packages/persistence/src/testing.ts", import.meta.url).pathname,
  ...
  test: {
    ...
    // PostgreSQL database (see roadmap/act-1-foundation/active/operations/findings.md's cross-suite retention_class
    ...
    // Carnegie browser specs are owned by Playwright, not Vitest.
    exclude: ["**/node_modules/**", "**/dist/**", ".git/**", ".worktrees/**", "testbed/**", "apps/carnegie/tests/**"],
  },
});
